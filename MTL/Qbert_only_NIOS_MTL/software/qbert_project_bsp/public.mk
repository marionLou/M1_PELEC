...
# design component names. 
SOPCINFO_FILE := $(ABS_BSP_ROOT_DIR)/../../qbert_only.sopcinfo
...
# Design Name 
# setting SOPC_NAME is qbert_only
SOPC_NAME := qbert_only
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x11450
SOPC_SYSID_FLAG += --sidp=0x11450
ELF_PATCH_FLAG  += --sidp 0x11450

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1459266194
SOPC_SYSID_FLAG += --timestamp=1459266194
ELF_PATCH_FLAG  += --timestamp 1459266194
