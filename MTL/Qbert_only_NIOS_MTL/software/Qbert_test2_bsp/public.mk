...
JDI_FILE := $(ABS_BSP_ROOT_DIR)/../../DE0_NANO.jdi

# Qsys--generated SOPCINFO file. Required for resolving node instance ID's with 
# design component names. 
SOPCINFO_FILE := $(ABS_BSP_ROOT_DIR)/../../qbert_test2.sopcinfo
...
# Design Name 
# setting SOPC_NAME is qbert_test2
SOPC_NAME := qbert_test2
...
# The SOPC System ID 
# setting SOPC_SYSID is 34
SOPC_SYSID_FLAG += --id=34
ELF_PATCH_FLAG  += --id 34

# The SOPC System ID Base Address 
# setting SOPC_SYSID_BASE_ADDRESS is 0x11490
SOPC_SYSID_FLAG += --sidp=0x11490
ELF_PATCH_FLAG  += --sidp 0x11490

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1459253078
SOPC_SYSID_FLAG += --timestamp=1459253078
ELF_PATCH_FLAG  += --timestamp 1459253078
