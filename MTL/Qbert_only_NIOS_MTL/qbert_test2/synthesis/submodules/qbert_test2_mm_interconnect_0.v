// qbert_test2_mm_interconnect_0.v
...
`timescale 1 ps / 1 ps
module qbert_test2_mm_interconnect_0 (
	...
	wire   [6:0] cmd_mux_001_src_channel;                                                   // cmd_mux_001:src_channel -> sysid_qsys_0_control_slave_agent:cp_channel
	...
	wire         cmd_mux_004_src_valid;                                                     // cmd_mux_004:src_valid -> Button_s1_agent:cp_valid
	wire  [92:0] cmd_mux_004_src_data;                                                      // cmd_mux_004:src_data -> Button_s1_agent:cp_data
	wire         cmd_mux_004_src_ready;                                                     // Button_s1_agent:cp_ready -> cmd_mux_004:src_ready
	wire   [6:0] cmd_mux_004_src_channel;                                                   // cmd_mux_004:src_channel -> Button_s1_agent:cp_channel
	wire         cmd_mux_004_src_startofpacket;                                             // cmd_mux_004:src_startofpacket -> Button_s1_agent:cp_startofpacket
	wire         cmd_mux_004_src_endofpacket;                                               // cmd_mux_004:src_endofpacket -> Button_s1_agent:cp_endofpacket
	...
	wire  [92:0] cmd_mux_005_src_data;                                                      // cmd_mux_005:src_data -> Switches_s1_agent:cp_data
	...
	wire  [16:0] timer_0_s1_agent_m0_address;                                               // timer_0_s1_agent:m0_address -> timer_0_s1_translator:uav_address
	...
	wire  [93:0] timer_0_s1_agent_rf_source_data;                                           // timer_0_s1_agent:rf_source_data -> timer_0_s1_agent_rsp_fifo:in_data
	...
	wire  [93:0] timer_0_s1_agent_rsp_fifo_out_data;                                        // timer_0_s1_agent_rsp_fifo:out_data -> timer_0_s1_agent:rf_sink_data
	...
	wire  [92:0] cmd_mux_006_src_data;                                                      // cmd_mux_006:src_data -> timer_0_s1_agent:cp_data
	...
	wire         button_s1_agent_rp_valid;                                                  // Button_s1_agent:rp_valid -> router_006:sink_valid
	wire  [92:0] button_s1_agent_rp_data;                                                   // Button_s1_agent:rp_data -> router_006:sink_data
	wire         button_s1_agent_rp_ready;                                                  // router_006:sink_ready -> Button_s1_agent:rp_ready
	wire         button_s1_agent_rp_startofpacket;                                          // Button_s1_agent:rp_startofpacket -> router_006:sink_startofpacket
	wire         button_s1_agent_rp_endofpacket;                                            // Button_s1_agent:rp_endofpacket -> router_006:sink_endofpacket
	...
	wire  [92:0] switches_s1_agent_rp_data;                                                 // Switches_s1_agent:rp_data -> router_007:sink_data
	...
	wire  [92:0] timer_0_s1_agent_rp_data;                                                  // timer_0_s1_agent:rp_data -> router_008:sink_data
	...
	wire         button_s1_agent_rdata_fifo_src_valid;                                      // Button_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_004:in_0_valid
	wire  [33:0] button_s1_agent_rdata_fifo_src_data;                                       // Button_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_004:in_0_data
	wire         button_s1_agent_rdata_fifo_src_ready;                                      // avalon_st_adapter_004:in_0_ready -> Button_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_004_out_0_valid;                                         // avalon_st_adapter_004:out_0_valid -> Button_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_004_out_0_data;                                          // avalon_st_adapter_004:out_0_data -> Button_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_004_out_0_ready;                                         // Button_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_004:out_0_ready
	wire   [0:0] avalon_st_adapter_004_out_0_error;                                         // avalon_st_adapter_004:out_0_error -> Button_s1_agent:rdata_fifo_sink_error
	...
	qbert_test2_mm_interconnect_0_router router (
	...
	qbert_test2_mm_interconnect_0_router_001 router_001 (
	...
	qbert_test2_mm_interconnect_0_router_002 router_002 (
	...
	qbert_test2_mm_interconnect_0_router_002 router_003 (
	...
	qbert_test2_mm_interconnect_0_router_004 router_004 (
	...
	qbert_test2_mm_interconnect_0_router_004 router_005 (
	...
	qbert_test2_mm_interconnect_0_router_002 router_006 (
	...
	qbert_test2_mm_interconnect_0_router_002 router_007 (
	...
	qbert_test2_mm_interconnect_0_router_002 router_008 (
	...
	qbert_test2_mm_interconnect_0_cmd_demux cmd_demux (
		.clk                (clk_0_clk_clk),                         //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	qbert_test2_mm_interconnect_0_cmd_demux_001 cmd_demux_001 (
		.clk                (clk_0_clk_clk),                         //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	qbert_test2_mm_interconnect_0_cmd_mux cmd_mux (
		.clk                 (clk_0_clk_clk),                         //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	qbert_test2_mm_interconnect_0_cmd_mux cmd_mux_001 (
		.clk                 (clk_0_clk_clk),                         //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	qbert_test2_mm_interconnect_0_cmd_mux_002 cmd_mux_002 (
		.clk                 (clk_0_clk_clk),                         //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	qbert_test2_mm_interconnect_0_cmd_mux_002 cmd_mux_003 (
		.clk                 (clk_0_clk_clk),                         //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	qbert_test2_mm_interconnect_0_cmd_mux cmd_mux_004 (
		.clk                 (clk_0_clk_clk),                         //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	qbert_test2_mm_interconnect_0_cmd_mux cmd_mux_005 (
		.clk                 (clk_0_clk_clk),                         //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	qbert_test2_mm_interconnect_0_cmd_mux cmd_mux_006 (
		.clk                 (clk_0_clk_clk),                         //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	qbert_test2_mm_interconnect_0_rsp_demux rsp_demux (
		.clk                (clk_0_clk_clk),                         //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	qbert_test2_mm_interconnect_0_rsp_demux rsp_demux_001 (
		.clk                (clk_0_clk_clk),                         //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	qbert_test2_mm_interconnect_0_cmd_demux_001 rsp_demux_002 (
		.clk                (clk_0_clk_clk),                         //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	qbert_test2_mm_interconnect_0_cmd_demux_001 rsp_demux_003 (
		.clk                (clk_0_clk_clk),                         //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	qbert_test2_mm_interconnect_0_rsp_demux rsp_demux_004 (
		.clk                (clk_0_clk_clk),                         //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	qbert_test2_mm_interconnect_0_rsp_demux rsp_demux_005 (
		.clk                (clk_0_clk_clk),                         //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	qbert_test2_mm_interconnect_0_rsp_demux rsp_demux_006 (
		.clk                (clk_0_clk_clk),                         //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	qbert_test2_mm_interconnect_0_rsp_mux rsp_mux (
		.clk                 (clk_0_clk_clk),                         //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	qbert_test2_mm_interconnect_0_rsp_mux_001 rsp_mux_001 (
		.clk                 (clk_0_clk_clk),                         //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	qbert_test2_mm_interconnect_0_avalon_st_adapter #(
		.inBitsPerSymbol (34),
		.inUsePackets    (0),
		.inDataWidth     (34),
		.inChannelWidth  (0),
