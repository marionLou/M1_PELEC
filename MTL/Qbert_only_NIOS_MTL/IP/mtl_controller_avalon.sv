// Code-test for moving only the qbert.
// --------------------------------------------------------------------
...
logic [4:0] A_xdiag_demi = 4'd2;
logic [4:0] A_ydiag_demi = 4'd3;
...
logic [4:0] A_qbert_position_x0 = 4'd4;
logic [4:0] A_qbert_position_y0 = 4'd5;
...
begin
	if (Avalon_reset) begin
		enable <= 1'd0;
		XLENGTH <= 11'd0;
		{XDIAG_DEMI, YDIAG_DEMI} <= 21'd0;
		{QBERT_POSITION_X0, QBERT_POSITION_Y0} <= 21'd0;
		qbert_jump <= 1'd0;
	end
	else begin 
		if (Avalon_write) begin 
			case(Avalon_address)
				...
				A_xdiag_demi : XDIAG_DEMI <= Avalon_writedata[10:0];
				A_ydiag_demi : YDIAG_DEMI <= Avalon_writedata[9:0];
				A_qbert_position_x0 : QBERT_POSITION_X0 <= Avalon_writedata[10:0];
				A_qbert_position_y0 : QBERT_POSITION_Y0 <= Avalon_writedata[9:0];
	 	...
	 	if (Avalon_read) begin 
			case(Avalon_address)
				...
				A_xdiag_demi : reg_readdata <= {21'b0,XDIAG_DEMI};
				A_ydiag_demi : reg_readdata <= {22'b0,YDIAG_DEMI};
				A_qbert_position_x0 : reg_readdata <= {21'b0,QBERT_POSITION_X0};
				A_qbert_position_y0 : reg_readdata <= {22'b0,QBERT_POSITION_Y0};
