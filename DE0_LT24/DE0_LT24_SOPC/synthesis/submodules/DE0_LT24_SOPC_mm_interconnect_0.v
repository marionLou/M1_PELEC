...
module DE0_LT24_SOPC_mm_interconnect_0 (
	...
	wire   [11:0] cmd_mux_001_src_channel;                                                   // cmd_mux_001:src_channel -> LT24_CTRL_avalon_slave_0_agent:cp_channel
	...
	wire   [11:0] cmd_mux_002_src_channel;                                                   // cmd_mux_002:src_channel -> LED_CTRL_avalon_slave_0_agent:cp_channel
	...
	wire   [11:0] cmd_mux_004_src_channel;                                                   // cmd_mux_004:src_channel -> ALT_PLL_pll_slave_agent:cp_channel
	...
	wire   [11:0] cmd_mux_006_src_channel;                                                   // cmd_mux_006:src_channel -> KEY_s1_agent:cp_channel
	...
	wire   [11:0] cmd_mux_007_src_channel;                                                   // cmd_mux_007:src_channel -> TIMER_s1_agent:cp_channel
	...
	wire   [11:0] cmd_mux_008_src_channel;                                                   // cmd_mux_008:src_channel -> LT24_LCD_RSTN_s1_agent:cp_channel
	...
	wire   [11:0] cmd_mux_009_src_channel;                                                   // cmd_mux_009:src_channel -> LT24_TOUCH_PENIRQ_N_s1_agent:cp_channel
	...
	wire   [11:0] cmd_mux_010_src_channel;                                                   // cmd_mux_010:src_channel -> LT24_TOUCH_BUSY_s1_agent:cp_channel
	...
	wire          cmd_mux_011_src_valid;                                                     // cmd_mux_011:src_valid -> LT24_TOUCH_SPI_spi_control_port_agent:cp_valid
	wire  [104:0] cmd_mux_011_src_data;                                                      // cmd_mux_011:src_data -> LT24_TOUCH_SPI_spi_control_port_agent:cp_data
	wire          cmd_mux_011_src_ready;                                                     // LT24_TOUCH_SPI_spi_control_port_agent:cp_ready -> cmd_mux_011:src_ready
	wire   [11:0] cmd_mux_011_src_channel;                                                   // cmd_mux_011:src_channel -> LT24_TOUCH_SPI_spi_control_port_agent:cp_channel
	wire          cmd_mux_011_src_startofpacket;                                             // cmd_mux_011:src_startofpacket -> LT24_TOUCH_SPI_spi_control_port_agent:cp_startofpacket
	wire          cmd_mux_011_src_endofpacket;                                               // cmd_mux_011:src_endofpacket -> LT24_TOUCH_SPI_spi_control_port_agent:cp_endofpacket
	...
	wire          lt24_touch_spi_spi_control_port_agent_rp_valid;                            // LT24_TOUCH_SPI_spi_control_port_agent:rp_valid -> router_013:sink_valid
	wire  [104:0] lt24_touch_spi_spi_control_port_agent_rp_data;                             // LT24_TOUCH_SPI_spi_control_port_agent:rp_data -> router_013:sink_data
	wire          lt24_touch_spi_spi_control_port_agent_rp_ready;                            // router_013:sink_ready -> LT24_TOUCH_SPI_spi_control_port_agent:rp_ready
	wire          lt24_touch_spi_spi_control_port_agent_rp_startofpacket;                    // LT24_TOUCH_SPI_spi_control_port_agent:rp_startofpacket -> router_013:sink_startofpacket
	wire          lt24_touch_spi_spi_control_port_agent_rp_endofpacket;                      // LT24_TOUCH_SPI_spi_control_port_agent:rp_endofpacket -> router_013:sink_endofpacket
	...
	wire   [11:0] router_007_src_channel;                                                    // router_007:src_channel -> SDRAM_s1_rsp_width_adapter:in_channel
	...
	wire   [11:0] sdram_s1_rsp_width_adapter_src_channel;                                    // SDRAM_s1_rsp_width_adapter:out_channel -> rsp_demux_005:sink_channel
	...
	wire   [11:0] cmd_mux_005_src_channel;                                                   // cmd_mux_005:src_channel -> SDRAM_s1_cmd_width_adapter:in_channel
	...
	wire   [11:0] cmd_demux_src4_channel;                                                    // cmd_demux:src4_channel -> crosser_001:in_channel
	...
	wire   [11:0] crosser_001_out_channel;                                                   // crosser_001:out_channel -> cmd_mux_004:sink0_channel
	...
	wire   [11:0] cmd_demux_src6_channel;                                                    // cmd_demux:src6_channel -> crosser_002:in_channel
	...
	wire   [11:0] crosser_002_out_channel;                                                   // crosser_002:out_channel -> cmd_mux_006:sink0_channel
	...
	wire   [11:0] cmd_demux_src7_channel;                                                    // cmd_demux:src7_channel -> crosser_003:in_channel
	...
	wire   [11:0] crosser_003_out_channel;                                                   // crosser_003:out_channel -> cmd_mux_007:sink0_channel
	...
	wire  [104:0] rsp_demux_002_src0_data;                                                   // rsp_demux_002:src0_data -> crosser_004:in_data
	...
	wire  [104:0] crosser_004_out_data;                                                      // crosser_004:out_data -> rsp_mux:sink2_data
	...
	wire  [104:0] rsp_demux_004_src0_data;                                                   // rsp_demux_004:src0_data -> crosser_005:in_data
	wire          rsp_demux_004_src0_ready;                                                  // crosser_005:in_ready -> rsp_demux_004:src0_ready
	wire   [11:0] rsp_demux_004_src0_channel;                                                // rsp_demux_004:src0_channel -> crosser_005:in_channel
	...
	wire  [104:0] crosser_005_out_data;                                                      // crosser_005:out_data -> rsp_mux:sink4_data
	wire          crosser_005_out_ready;                                                     // rsp_mux:sink4_ready -> crosser_005:out_ready
	wire   [11:0] crosser_005_out_channel;                                                   // crosser_005:out_channel -> rsp_mux:sink4_channel
	...
	wire  [104:0] rsp_demux_006_src0_data;                                                   // rsp_demux_006:src0_data -> crosser_006:in_data
	wire          rsp_demux_006_src0_ready;                                                  // crosser_006:in_ready -> rsp_demux_006:src0_ready
	wire   [11:0] rsp_demux_006_src0_channel;                                                // rsp_demux_006:src0_channel -> crosser_006:in_channel
	...
	wire  [104:0] crosser_006_out_data;                                                      // crosser_006:out_data -> rsp_mux:sink6_data
	wire          crosser_006_out_ready;                                                     // rsp_mux:sink6_ready -> crosser_006:out_ready
	wire   [11:0] crosser_006_out_channel;                                                   // crosser_006:out_channel -> rsp_mux:sink6_channel
	...
	wire  [104:0] rsp_demux_007_src0_data;                                                   // rsp_demux_007:src0_data -> crosser_007:in_data
	wire          rsp_demux_007_src0_ready;                                                  // crosser_007:in_ready -> rsp_demux_007:src0_ready
	wire   [11:0] rsp_demux_007_src0_channel;                                                // rsp_demux_007:src0_channel -> crosser_007:in_channel
	...
	wire  [104:0] crosser_007_out_data;                                                      // crosser_007:out_data -> rsp_mux:sink7_data
	wire          crosser_007_out_ready;                                                     // rsp_mux:sink7_ready -> crosser_007:out_ready
	wire   [11:0] crosser_007_out_channel;                                                   // crosser_007:out_channel -> rsp_mux:sink7_channel
	...
	wire          lt24_touch_spi_spi_control_port_agent_rdata_fifo_src_valid;                // LT24_TOUCH_SPI_spi_control_port_agent:rdata_fifo_src_valid -> avalon_st_adapter_011:in_0_valid
	wire   [33:0] lt24_touch_spi_spi_control_port_agent_rdata_fifo_src_data;                 // LT24_TOUCH_SPI_spi_control_port_agent:rdata_fifo_src_data -> avalon_st_adapter_011:in_0_data
	wire          lt24_touch_spi_spi_control_port_agent_rdata_fifo_src_ready;                // avalon_st_adapter_011:in_0_ready -> LT24_TOUCH_SPI_spi_control_port_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_011_out_0_valid;                                         // avalon_st_adapter_011:out_0_valid -> LT24_TOUCH_SPI_spi_control_port_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_011_out_0_data;                                          // avalon_st_adapter_011:out_0_data -> LT24_TOUCH_SPI_spi_control_port_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_011_out_0_ready;                                         // LT24_TOUCH_SPI_spi_control_port_agent:rdata_fifo_sink_ready -> avalon_st_adapter_011:out_0_ready
	wire    [0:0] avalon_st_adapter_011_out_0_error;                                         // avalon_st_adapter_011:out_0_error -> LT24_TOUCH_SPI_spi_control_port_agent:rdata_fifo_sink_error
